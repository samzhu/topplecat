...
assert_artifact_version "$junit_sample/build.gradle.kts" "0.0.5"
assert_artifact_version "$spring_sample/build.gradle.kts" "0.0.5"
assert_artifact_version "$root/integration-tests/mutation-gate/build.gradle.kts" "0.0.5"
