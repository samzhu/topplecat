...
are not project dependencies or an included build. For normal use, once
`0.0.4` is available in Maven Central, use the setup in the root
[README](../README.md#install-004) instead.
