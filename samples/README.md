...
The samples are independent Gradle consumers. They resolve the locally published
ToppleCat snapshot from Maven local; they are not project dependencies or an
included build.
