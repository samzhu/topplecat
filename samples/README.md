...
Both samples show the 0.2.0 boundary: public acceptance methods, public rows,
...
The JUnit project uses its own Gradle Wrapper and released Maven Central 0.2.0
