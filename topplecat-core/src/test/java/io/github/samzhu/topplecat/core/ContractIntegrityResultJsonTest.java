...
class ContractIntegrityResultJsonTest {
    ...
    void roundTripsReviewerOnlyMismatchDiagnostics() {
        ContractIntegrityResult result = new ContractIntegrityResult(
        ...
        assertEquals(result, ContractIntegrityResultJson.read(ContractIntegrityResultJson.write(result)));
    }

    @Test
    void rejectsDisabledIntegrityResults() {
        assertThrows(ToppleCatException.class, () -> new ContractIntegrityResult(
                ContractIntegrityResult.SCHEMA_VERSION,
