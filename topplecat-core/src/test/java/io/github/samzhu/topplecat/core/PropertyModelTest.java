...
class PropertyModelTest {
  ...
  void propertyPolicyAndScopeAreExplicitAndTamperEvident() {
    VerificationPolicy enabled = new VerificationPolicy("0.0.15", true, true, true, true, 100);
    VerificationPolicy disabled = new VerificationPolicy("0.0.15", true, true, false, true, 100);
