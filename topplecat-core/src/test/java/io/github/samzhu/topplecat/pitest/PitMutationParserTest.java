...
class PitMutationParserTest {
    ...
    List<PitMutationAssessment> assessments =
        PitMutationAttributor.assess(
            ...
            Map.of(
                "AC-COUPON",
                    Set.of(
                        "shop.OrderAcceptanceTest#appliesCoupon(Lio/github/samzhu/topplecat/junit/ToppleCase;)V"),
                "AC-EMPTY",
                    Set.of(
  ...
  void doesNotAttributeAnUnmarkedInvocationByClassNameAlone() {
    ...
    PitMutationAssessment assessment =
        PitMutationAttributor.assess(
                report,
                Map.of(
                    "AC-COUPON",
        ...
        () ->
            PitMutationAttributor.assess(
                ...
                Map.of(
                    "AC-COUPON",
                    Set.of(
                        "shop.CouponTest#appliesCoupon(Lio/github/samzhu/topplecat/junit/ToppleCase;)V")),
                100));
  }
}
