...
public record CaseRun(String caseId, NarrativeStepStatus status, Duration duration, List<StepRun> stepRuns,
                      Map<String, String> expectedConsumption, String failureRef) {
    public CaseRun {
