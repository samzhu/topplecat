...
public record CaseDefinition(String caseId, String acId, CaseVisibility visibility, JsonNode inputs, JsonNode expected) {
    public CaseDefinition {
        ...
        if (inputs == null || !inputs.isObject() || expected == null || !expected.isObject()) {
            throw new ToppleCatException("Case definition " + caseId + " requires object inputs and expected values.");
        }
