...
public record StepRun(String stepId, NarrativeStepStatus status, Duration duration, List<Object> actualArguments,
                      List<AttachmentRef> attachments, String failureRef) {
    public StepRun {
