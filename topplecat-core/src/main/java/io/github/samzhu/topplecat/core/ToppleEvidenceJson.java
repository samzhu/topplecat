...
public final class ToppleEvidenceJson {
  ...
  public static ToppleEvidence create(
    ...
    return new ToppleEvidence(
        ToppleEvidence.SCHEMA_VERSION, runId, generatedAt, verdict, gates, artifactDigests, hash);
  }
  ...
  private static String hash(
    ...
    EvidencePayload payload =
        new EvidencePayload(
            ToppleEvidence.SCHEMA_VERSION,
            runId,
            generatedAt,
            verdict,
            List.copyOf(gates == null ? List.of() : gates),
            new TreeMap<>(artifactDigests == null ? Map.of() : artifactDigests));
