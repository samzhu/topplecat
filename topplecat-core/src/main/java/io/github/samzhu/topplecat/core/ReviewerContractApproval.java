...
public record ReviewerContractApproval(
    ...
    public static final String SCHEMA_VERSION = "topplecat.contract-approval.v2";
    ...
    public ReviewerContractApproval {
        ...
        String expected = digest(publicFiles, publicDefinitionDigest, verificationPolicy, selectedSpecScope);
    ...
    public static ReviewerContractApproval create(
        ...
        return create(publicFiles, publicDefinitionDigest, verificationPolicy, SelectedSpecScope.empty());
    }
    ...
    public static ReviewerContractApproval create(
        ...
        SelectedSpecScope scope = selectedSpecScope == null ? SelectedSpecScope.empty() : selectedSpecScope;
        String digest = digest(canonicalFiles, publicDefinitionDigest, verificationPolicy, scope);
        return new ReviewerContractApproval(SCHEMA_VERSION, canonicalFiles, publicDefinitionDigest, verificationPolicy, scope, digest);
    }
    ...
    static String digest(
        ...
        ApprovalPayload payload = new ApprovalPayload(SCHEMA_VERSION, List.copyOf(publicFiles == null ? List.of() : publicFiles),
                publicDefinitionDigest, verificationPolicy, selectedSpecScope);
