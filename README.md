...
ToppleCat 0.0.28 requires Java 25 and a compatible Gradle version.

```kotlin
plugins {
    java
    id("io.github.samzhu.topplecat") version "0.0.28"
}

dependencies {
    testImplementation("io.github.samzhu.topplecat:topplecat-junit:0.0.28")
...
- [0.0.28 release notes](docs/releases/0.0.28.md)
- [JUnit sample](samples/junit-cart-orders)
