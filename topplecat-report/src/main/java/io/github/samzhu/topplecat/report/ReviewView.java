...
public record ReviewView(String schemaVersion, Instant generatedAt, List<ReviewAcceptanceCondition> acceptanceConditions,
    ...
    public static final String SCHEMA_VERSION = "topplecat.review-view.v3";
    ...
    public ReviewView(String schemaVersion, Instant generatedAt, List<ReviewAcceptanceCondition> acceptanceConditions) {
