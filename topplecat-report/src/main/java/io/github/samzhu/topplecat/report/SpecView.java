...
public record SpecView(
    String schemaVersion, Instant generatedAt, List<SpecAcceptanceCondition> acceptanceConditions) {
  public static final String SCHEMA_VERSION = "topplecat.spec-view.v4";
