(() => {
  ...
  const catalogs = {
    en: {
      ...
      'mutation.none': 'No current managed PIT attribution was available.', 'mutation.pitStatus': 'PIT status', 'mutation.detected': 'Detected', 'mutation.mutants': 'Mutants', 'mutation.profile': 'PIT {0}, managed profile {1}.', 'mutation.global': 'PIT global outcome', 'mutation.detectedCount': '{0}/{1} mutants were detected by at least one test.', 'mutation.globalMeaning': 'This PIT-wide observation does not mean that every Acceptance Method detected every mutant.', 'mutation.producerCounts': '{0} producer mutants. {1} uniquely attributed. {2} unattributed.', 'mutation.operatorIds': 'Managed operator IDs', 'mutation.rawOutcomes': 'Raw producer outcomes', 'mutation.perAc': 'Per-AC Acceptance Method detection', 'mutation.perAcMeaning': "The Mutation Gate uses each Acceptance Method's covered-mutant detection rate against its sealed threshold. It does not blend this rate with PIT's global outcome.", 'mutation.ac': 'AC', 'mutation.covered': 'Covered', 'mutation.detectedByMethod': 'Detected by Acceptance Method', 'mutation.threshold': 'Threshold', 'mutation.rate': 'Detection rate', 'mutation.gap': '{0} has no managed-profile attribution evidence in this run. Reviewer judgment is required.', 'mutation.rawFindings': 'Raw PIT findings', 'mutation.mutant': 'Mutant {0}', 'mutation.mutator': 'Mutator {0}. Detected: {1}.', 'mutation.coveringTests': 'coveringTests', 'mutation.killingTests': 'killingTests', 'mutation.succeedingTests': 'succeedingTests',
    ...
    'zh-TW': {
      ...
      'mutation.none': '沒有可用的本次受管理 PIT 歸因。', 'mutation.pitStatus': 'PIT 狀態', 'mutation.detected': '已偵測', 'mutation.mutants': '突變體', 'mutation.profile': 'PIT {0}，受管理設定檔 {1}。', 'mutation.global': 'PIT 全域結果', 'mutation.detectedCount': '{0}/{1} 個突變體至少被一項測試偵測到。', 'mutation.globalMeaning': '這個 PIT 全域觀察不代表每個驗收方法都偵測到每個突變體。', 'mutation.producerCounts': '{0} 個 producer 突變體；{1} 個獲得唯一歸因；{2} 個未歸因。', 'mutation.operatorIds': '受管理運算子 ID', 'mutation.rawOutcomes': '原始 producer 結果', 'mutation.perAc': '每個 AC 的驗收方法偵測結果', 'mutation.perAcMeaning': 'Mutation Gate 會以每個驗收方法對已涵蓋突變體的偵測率，比對其封印的門檻；不會與 PIT 全域結果混合。', 'mutation.ac': 'AC', 'mutation.covered': '已涵蓋', 'mutation.detectedByMethod': '由驗收方法偵測', 'mutation.threshold': '門檻', 'mutation.rate': '偵測率', 'mutation.gap': '{0} 在這次執行沒有取得 managed-profile 歸因證據，需要審閱者判斷。', 'mutation.rawFindings': '原始 PIT 發現', 'mutation.mutant': '突變體 {0}', 'mutation.mutator': 'Mutator {0}。已偵測：{1}。', 'mutation.coveringTests': 'coveringTests', 'mutation.killingTests': 'killingTests', 'mutation.succeedingTests': 'succeedingTests',
  ...
  const mutation = () => {
    ...
    if (!value) return `${gateCard(gateValue)}<p class="meta">${t('mutation.none')}</p>`;
